...
\section{Образование}
  \resumeSubHeadingListStart
    \resumeSubheading
      {МГТУ им. Н.Э.Баумана}{Сен. 2019 -- Июль. 2023}
      {Бакалавр "Управление в технических системах"\ код:  \textbf{27.03.04}}{Москва}
       \resumeSubheading
      {Школа 1502 при МЭИ}{}
      {Среднее полное образование}{Москва}
 ...
 \section{Дополнительное образование}
  \resumeSubHeadingListStart
      ...
      \resumeSubheading
      {Курс "Алгоритмы и структуры данных"\ в рамках трека Web-разработчик}{}
      {Vk Образование}{}
      
      \resumeSubheading
      {Курс "Web-технологии"\ в рамках трека Web-разработчик}{}
      {Vk Образование}{}
...
\section{Стек технологий}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Языки программрования}{: C, C++, Go, Bash, Python, SQL} \\
    %  \textbf{Developer Tools}{: VS Code, Eclipse, Google Cloud Platform, Android Studio} \\
    
    
     \textbf{Технологии и фреймфорки}{: Linux, Git, Bootstrap, Django,  HTML/CSS } \\
    }}
 \end{itemize}
 \vspace{-16pt}
